...
<body class="bg-gray-50 font-sans text-sm">
        ...
        <div class="mx-auto max-w-6xl">
            <div class="mb-6 flex items-center justify-between">
                <div>
                    ...
                    <p class="text-sm text-gray-600">Create and manage your PDF templates</p>
                </div>
                <button
                    onclick="TemplateModal.open()"
                    class="rounded-lg bg-blue-600 px-4 py-2 font-medium text-white shadow-sm transition-colors hover:bg-blue-700"
                >
                    New Template
                </button>
            </div>
            ...
            <div id="alertContainer" class="mb-4 hidden">
                <div id="alertMessage" class="rounded-lg border px-4 py-3">
                    <span class="flex-1"></span>
                </div>
            </div>

            <div id="templatesContainer" class="hidden rounded-lg border border-gray-200 bg-white shadow-sm">
                <div class="border-b border-gray-200">
                    <div class="flex items-center justify-between px-4 py-3">
                        <h2 class="font-semibold text-gray-900">Templates</h2>
                        <div class="text-xs text-gray-500"><span id="templateCount">0</span> total</div>
                    </div>
                </div>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full">
                        ...
                        <thead class="border-b border-gray-200 bg-gray-50">
                            <tr>
                                <th class="px-4 py-2 text-left text-xs font-medium tracking-wider text-gray-600 uppercase">
                                    Slugs
                                </th>
                                <th class="px-4 py-2 text-left text-xs font-medium tracking-wider text-gray-600 uppercase">
                                    Lang
            ...
            <div id="emptyState" class="hidden rounded-lg border border-gray-200 bg-white shadow-sm">
                <div class="py-12 text-center">
                    <div class="mx-auto max-w-md">
                        <h3 class="mb-2 text-lg font-medium text-gray-900">No templates found</h3>
    ...
    <div id="templateModal" class="bg-opacity-50 fixed inset-0 z-40 hidden bg-black">
        <div class="flex h-screen flex-col">
            <div class="border-b border-gray-200 bg-white px-6 py-4">
                <div class="flex items-center justify-between">
                    <div>
                        <h2 id="modalTitle" class="text-xl font-bold text-gray-900">New Template</h2>
                        <p class="text-sm text-gray-600">Configure your template settings</p>
                    </div>
                    <button
                    ...
                    <div class="mx-auto max-w-4xl p-6">
                        <form id="templateForm" class="space-y-6">
                            ...
                            <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
                                <h3 class="mb-4 text-lg font-medium text-gray-900">Basic Settings</h3>

                                <div class="grid grid-cols-1 gap-4 lg:grid-cols-2">
                                    <div
                                        x-data="MultiSlugTagsInputComponent()"
                                        x-init="initialize(INITIAL_PAGE_SLUGS)"
                                        id="slugTagsBox"
                                    >
                                        <label class="mb-2 block text-sm font-medium text-gray-700">Page Slugs *</label>

                                        <div class="rounded-lg border border-gray-300 bg-white p-2 focus-within:border-blue-500 focus-within:ring-2 focus-within:ring-blue-500">
                                            <div class="flex flex-wrap gap-2">
                                                <template
                                                    x-for="(slugValue, slugIndex) in selectedValues"
                                                    :key="slugValue"
                                                >
                                                    <span class="inline-flex items-center rounded-full border border-blue-200 bg-blue-50 px-2 py-1 text-xs text-blue-800">
                                                        <span x-text="slugValue"></span>
                                                        <button
                                                            type="button"
                                                            class="ml-1 text-blue-600 hover:text-blue-800"
                                                            @click="removeByIndex(slugIndex)"
                                                        >
                                                            Remove
                                                        </button>
                                                    </span>
                                                ...
                                                <input
                                                    ...
                                                    @keydown.,.prevent="addFromInput()"
                                                    @keydown.tab="addIfFilled()"
                                                    placeholder="type slug and Enter"
                                                    class="min-w-[10ch] flex-1 px-2 py-1 text-sm outline-none"
                                                />
                                            </div>
                                        </div>

                                        <div class="mt-2">
                                            <div class="mb-1 text-xs text-gray-500">Available</div>
                                            <div class="flex flex-wrap gap-2">
                                        ...
                                        <input
                                            id="page_required_guard"
                                            type="text"
                                            class="hidden"
                                            required
                                            x-bind:value="selectedValues.length ? 'ok' : ''"
                                        />
                                        <div id="pageError" class="mt-1 hidden text-xs font-medium text-red-500"></div>
                                    </div>

                                    <div>
                                        <label class="mb-2 block text-sm font-medium text-gray-700">Language Code *</label>
                                        <input
                                            type="text"
                                            id="lang"
                                            name="lang"
                                            placeholder="en"
                                            maxlength="5"
                                            class="w-full rounded-lg border border-gray-300 bg-white px-3 py-2 transition-colors focus:border-blue-500 focus:ring-2 focus:ring-blue-500"
                                            oninput="FormValidation.showNone('lang')"
                                            required
                                        />
                                        <div id="langError" class="mt-1 hidden text-xs font-medium text-red-500"></div>
                                    </div>
                                </div>
                            </div>

                            <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
                                <h3 class="mb-4 text-lg font-medium text-gray-900">Page Configuration</h3>

                                <div class="mb-4 grid grid-cols-2 gap-4">
                                    <div>
                                        <label class="mb-2 block text-sm font-medium text-gray-700">Paper Size</label>
                                        <select
                                            id="paperSize"
                                            name="paper_size"
                                            class="w-full rounded-lg border border-gray-300 bg-white px-3 py-2 focus:border-blue-500 focus:ring-2 focus:ring-blue-500"
                                        >
                                    ...
                                    <div>
                                        <label class="mb-2 block text-sm font-medium text-gray-700">Orientation</label>
                                        <select
                                            id="orientation"
                                            name="orientation"
                                            class="w-full rounded-lg border border-gray-300 bg-white px-3 py-2 focus:border-blue-500 focus:ring-2 focus:ring-blue-500"
                                ...
                                <div>
                                    <h4 class="mb-3 text-sm font-medium text-gray-700">Margins &amp; Spacing (mm)</h4>
                                    <div class="grid grid-cols-3 gap-3 lg:grid-cols-6">
                                        <div>
                                            <label class="mb-1 block text-xs text-gray-600">Top</label>
                                            <input
                                                type="number"
                                                id="marginTop"
                                                name="margin_top"
                                                step="0.1"
                                                value="20"
                                                class="w-full rounded border border-gray-300 bg-white px-2 py-2 text-xs"
                                            />
                                        </div>
                                        <div>
                                            <label class="mb-1 block text-xs text-gray-600">Bottom</label>
                                            <input
                                                type="number"
                                                id="marginBottom"
                                                name="margin_bottom"
                                        ...
                                        <div>
                                            <label class="mb-1 block text-xs text-gray-600">Left</label>
                                            <input
                                                type="number"
                                                id="marginLeft"
                                                name="margin_left"
                                        ...
                                        <div>
                                            <label class="mb-1 block text-xs text-gray-600">Right</label>
                                            <input
                                                type="number"
                                                id="marginRight"
                                                name="margin_right"
                                        ...
                                        <div>
                                            <label class="mb-1 block text-xs text-gray-600">Header</label>
                                            <input
                                                type="number"
                                                id="headerSpace"
                                                name="header_space"
                                        ...
                                        <div>
                                            <label class="mb-1 block text-xs text-gray-600">Footer</label>
                                            <input
                                                type="number"
                                                id="footerSpace"
                                                name="footer_space"
                                ...
                                <div class="mt-4 grid grid-cols-4 gap-3">
                                    <label class="flex items-center">
                                        <input
                                            type="checkbox"
                                            id="disabled-smart-shrinking"
                                            name="disabled_smart_shrinking"
                            ...
                            <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
                                <h3 class="mb-4 text-lg font-medium text-gray-900">Content Sections</h3>
                                ...
                                <div class="space-y-4">
                                    <div>
                                        ...
                                        <textarea
                                            ...
                                            class="w-full rounded-lg border border-gray-300 bg-white px-3 py-2 font-mono text-xs focus:border-blue-500 focus:ring-2 focus:ring-blue-500"
                                    ...
                                    <div>
                                        ...
                                        <textarea
                                            ...
                                            name="content"
                                            rows="6"
                                            placeholder="Enter main content HTML..."
                                            class="w-full rounded-lg border border-gray-300 bg-white px-3 py-2 font-mono text-xs focus:border-blue-500 focus:ring-2 focus:ring-blue-500"
                            ...
                            <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
                                <h3 class="mb-4 text-lg font-medium text-gray-900">Security Verification</h3>
                                <div>
                                    ...
                                    <input
                                        ...
                                        id="password"
                                        name="password"
                                        placeholder="Enter password to save template changes"
                                        class="w-full rounded-lg border border-gray-300 bg-white px-3 py-2 font-mono text-xs focus:border-blue-500 focus:ring-2 focus:ring-blue-500"
                                        oninput="FormValidation.showNone('password')"
                                        required
                                    />
                                    <div id="passwordError" class="mt-1 hidden text-xs font-medium text-red-500"></div>
                                </div>
                            </div>
                        </form>
                    </div>
            ...
            <div class="border-t border-gray-200 bg-white px-6 py-4">
                <div class="flex items-center justify-between">
                    <div class="text-xs text-gray-500">Press Ctrl + S to save</div>
                    <div class="flex gap-3">
                        <button
                            type="button"
                            onclick="TemplateModal.close()"
                            class="rounded-lg border border-gray-300 px-6 py-2 font-medium text-gray-700 transition-colors hover:bg-gray-50"
                        >
                            Cancel
                        </button>
                        <button
                            type="button"
                            onclick="TemplateAPI.save()"
                            id="submitBtn"
                            class="rounded-lg bg-blue-600 px-6 py-2 font-medium text-white shadow-sm transition-colors hover:bg-blue-700 disabled:opacity-50"
                        >
        ...
        var ErrorDisplay = {
            ...
            showToast: function (message, type) {
                ...
                toastElement.className =
                    'fixed top-4 right-4 z-[70] px-4 py-3 rounded-lg border transform transition-all duration-300 translate-x-full max-w-sm shadow-sm';
                ...
                toastElement.innerHTML =
                    '<div class="flex items-center gap-2"><div class="flex-1"><p class="font-medium text-xs">' +
                    UtilityFunctions.escapeHtml(message) +
                    '</p></div><button onclick="this.parentElement.parentElement.remove()" class="text-gray-400 hover:text-gray-600">Close</button></div>';
        ...
        var TemplateTable = {
            ...
            showTemplatesContainer: function () {
                ...
                if (DocumentElements.templateCountElement) {
                    DocumentElements.templateCountElement.textContent = String(
                        TemplateApplicationState.filteredTemplates.length,
                    );
                }
            },
            ...
            renderRows: function () {
                DocumentElements.tableBodyElement.innerHTML = TemplateApplicationState.filteredTemplates
                    .map(function (templateItem) {
                        var pageArray = UtilityFunctions.toSlugArray(templateItem.page);
                        var slugChips = pageArray
                            .map(function (singleSlug) {
                                return (
                                    '<span class="mr-1 mb-1 inline-flex items-center px-2 py-0.5 rounded bg-gray-100 text-gray-800 border border-gray-200 text-xs">' +
                                    UtilityFunctions.escapeHtml(singleSlug) +
                                    '</span>'
                                );
                            })
                            .join(' ');
                        ...
                        return (
                            ...
                            '<td class="px-4 py-3"><div class="flex flex-wrap">' +
                            slugChips +
                            '</div></td>' +
                            '<td class="px-4 py-3"><span class="inline-flex items-center px-2 py-1 rounded text-xs font-medium bg-blue-100 text-blue-800">' +
                            languageDisplay +
                            '</span></td>' +
                            ...
                            '<button onclick="TemplateModal.edit(' +
                            templateItem.id +
                            ')" class="px-3 py-1.5 border border-blue-200 text-blue-700 hover:bg-blue-50 rounded-lg transition-colors text-xs">Edit</button>' +
                            '<button onclick="TemplateAPI.delete(' +
                            templateItem.id +
                            ')" class="px-3 py-1.5 border border-red-200 text-red-700 hover:bg-red-50 rounded-lg transition-colors text-xs">Delete</button>' +
                            '</div>' +
                            '</td>' +
                            '</tr>'
                        );
        ...
        var TemplateAPI = {
            ...
            save: async function () {
                ...
                try {
                    ...
                    var successMessage = TemplateApplicationState.editingTemplate
        ...
        var KeyboardShortcuts = {
            ...
            handleKeyDown: function (event) {
                ...
                if (
                    ...
                    !DocumentElements.templateModalElement.classList.contains('hidden')
                ) {
        ...
        var Application = {
            initialize: async function () {
                try {
                    ...
                    ErrorDisplay.showMainAlert(
                        'Failed to initialize application: ' + ErrorDisplay.getErrorMessage(error),
                        'error',
                    );
                }
            },
